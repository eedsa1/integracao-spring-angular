...
public class SchoolRestExceptionHandler extends ResponseEntityExceptionHandler{
	...
	@ExceptionHandler(ElementCanNotBeCreatedException.class)
	public ResponseEntity<?> handlerElementCanNotBeCreatedException(ElementCanNotBeCreatedException exception){
